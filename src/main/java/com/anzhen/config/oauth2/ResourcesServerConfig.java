...
public class ResourcesServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(ResourceServerSecurityConfigurer resources) {
        // 状态
        resources.stateless(true).accessDeniedHandler(authExceptionHandler)
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .antMatchers("/image/main/view", "/oauth/token", "/user/info/**", "/image/manual/get/image",
                "/update/thumbnail")
            .permitAll()
            .antMatchers("/public/**", "/oauth/public/**", "/webjars/**", "webjars/springfox-swagger-ui/**",
                "webjars/springfox-swagger-ui", "/configuration/**", "/swagger-ui.html", "/static/**", "/v2/api-docs**",
                "/swagger-resources/**")
